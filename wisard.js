...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'wisard.wast';
  var wasmBinaryFile = 'wisard.wasm';
  var asmjsCodeFile = 'wisard.temp.asm.js';
...
STATICTOP = STATIC_BASE + 32464;
/* global initializers */  __ATINIT__.push({ func: function() { __GLOBAL__I_000101() } }, { func: function() { __GLOBAL__sub_I_wisard_bind_cc() } }, { func: function() { __GLOBAL__sub_I_bind_cpp() } }, { func: function() { __GLOBAL__sub_I_iostream_cpp() } });
...
Module['wasmTableSize'] = 9504;

Module['wasmMaxTableSize'] = 9504;
...
var real___GLOBAL__sub_I_wisard_bind_cc = asm["__GLOBAL__sub_I_wisard_bind_cc"]; asm["__GLOBAL__sub_I_wisard_bind_cc"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real___GLOBAL__sub_I_wisard_bind_cc.apply(null, arguments);
};
...
var __GLOBAL__sub_I_wisard_bind_cc = Module["__GLOBAL__sub_I_wisard_bind_cc"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_wisard_bind_cc"].apply(null, arguments) };
